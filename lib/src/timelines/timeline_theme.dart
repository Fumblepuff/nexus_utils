...
///
/// {@tool snippet}
/// In this example, the [TimelineTheme] widget is used to configure the
/// appearance of the [Timeline] widget.
/// {@end-tool}
///
@immutable
class TimelineThemeData with Diagnosticable {
  ...
  factory TimelineThemeData({
    ...
    color ??=
        Colors.blue; // Need to change the default color to the theme color?
    nodePosition ??= 0.5;
