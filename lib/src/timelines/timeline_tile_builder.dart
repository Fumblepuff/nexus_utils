...
///
///  replace with class to support parameters
///
/// See also:
///
...
enum IndicatorStyle {
  ...
  /// Draw container indicator.  need child to builds...
  container,
...
class TimelineTileBuilder {
  ...
  ///
  /// {@macro timelines.itemExtentBuilder}
  /// style each index like fromStyleBuilder
  ///
  /// See also:
  ///
  ///  * [IndicatorStyle]
  ...
  /// {@endtemplate}
  ///
  /// need refactoring, is it has many builders...?
